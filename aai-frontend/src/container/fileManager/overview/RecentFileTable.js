...
const RecentFileTable = ({ folder }) => {
  ...
  if (FileManagerData !== null) {
    ...
    //                 <img src={require(`../../../static/img/files/pdf.png`)} alt="artifyai" />
    //               </div>
    ...
    //               <img src={require('../../../static/img/users/1.png')} alt="artifyai" />
    //               <img src={require('../../../static/img/users/2.png')} alt="artifyai" />
    //               <img src={require('../../../static/img/users/3.png')} alt="artifyai" />
    //               <img src={require('../../../static/img/users/4.png')} alt="artifyai" />
    //             </div>
    //           ),
    //           action: (
    //             <Dropdown
