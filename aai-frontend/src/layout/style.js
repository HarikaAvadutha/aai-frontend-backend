...
const Div = Styled.div`
    ...
    header{
        ...
        ${({ darkMode }) => (darkMode ? `background: #0B1A23;` : '')};
        z-index: 999;
        ...
        .ant-btn-link{
            ${({ darkMode }) =>
              darkMode ? `background: #0B1A23;border-color: #0B1A23;color: #7D808D !important` : ''};
        }

        .head-example{
            ${({ darkMode }) => (darkMode ? `color: #BAA06A;` : '')};
        }
    ...
    .certain-category-search-wrapper{
        ${({ darkMode, theme }) =>
          darkMode ? `${!theme.rtl ? 'border-right' : 'border-left'}: 1px solid #0B1A23;` : ''};
         @media only screen and (max-width: 767px){
            padding: 0 15px;
        }
        input{
    ...
    .ant-layout-sider{
            ...
            .ant-menu{
                ...
                .ant-menu-submenu, .ant-menu-item{
                    ...
                    img{
                        width: 16px;
                        font-size: 16px;
                        color: ${({ theme }) => theme['aai-gold-color']};
                    }
                    span{
                        display: inline-block;
                ...
                .ant-menu-item{
                    ...
                    &.ant-menu-item-active{
                        border-radius: 4px;
                        ${({ darkMode }) => (darkMode ? `background-color: rgba(186, 160, 106, .25);` : '')};
                    }
                    a{
                        width: 100%;
        ...
        .sidebar-nav-title{
            ...
            ${({ darkMode }) => (darkMode ? `color: rgba(255, 255, 255, .85);` : 'color: #9299B8;')};
...
const SmallScreenAuthInfo = Styled.div`
        ${({ darkMode }) => (darkMode ? `background: #0B1A23;` : 'background: #fff')};
        width: 100%;
        position: fixed;
...
const TopMenuSearch = Styled.div`
    ...
    .search-toggle{
        ...
        ${({ theme }) => (theme.darkMode ? `color: #0B1A23;` : 'color :#0B1A23')};
        .feather-x{
            display: none;
        }
        .feather-search{
    ...
    .topMenu-search-form{
        ...
        top: 12px;
        background-color: #0B1A23;
        border: 1px solid ${({ theme }) => theme['dark-color']};
        border-radius: 6px;
        height: 40px;
        width: 280px;
        display: none;
        ...
        svg{
            width: 18px;
            color: ${({ theme }) => (theme.darkMode ? `color: #BAA06A;` : 'color:# 9299b8')};
        }
        form{
            height: auto;
            display: flex;
